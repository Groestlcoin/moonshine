 ...
 */
export const getRecommendedFee = ({ coin = "groestlcoin", transactionSize = 256 } = {}) => (dispatch) => {
...
export const sendTransaction = ({ txHex = "", selectedCrypto = "groestlcoin", sendTransactionFallback = true } = {}) => (dispatch) => {
	return new Promise(async (resolve) => {
		const failure = (data = "") => {
